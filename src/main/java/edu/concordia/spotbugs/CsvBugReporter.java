...
public class CsvBugReporter extends TextUIBugReporter {
    ...
    public CsvBugReporter(String outputPath){
        ...
        String[] header = new String[] {"Violation","Package","Class","Method","Field","StartLine","EndLine","Priority","Category","File"};
...
//            sClass = aClass.getClassName();
        ...
        String[] bugRow = new String[] {bugAbbv,sPackage,sClass,sMethod,sField,String.valueOf(iStartLine),String.valueOf(iEndLine),priority,categoryAbbrev,sSourceFile};
